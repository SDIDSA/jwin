...
public class JWinProject {
	...
	private static final String RESOLVED_JARS = "resolvedJars";
	...
	public JWinProject(List<File> classpath, Entry<String, File> mainClass, File jdk, File jre, File icon,
			List<File> resolvedJars, List<File> manualJars, String appName, String appVersion,
			String appPublisher, boolean console, String guid) {
		this.classpath = new ArrayList<>(classpath);
		this.mainClass = mainClass;
		this.jdk = jdk;
		this.jre = jre;
		this.icon = icon;
		this.resolvedJars = new ArrayList<>(resolvedJars);
	...
	public String serialize() {
		...
		data.put(RESOLVED_JARS, serializeFileList(resolvedJars));
	...
	public static JWinProject deserialize(String data) {
		...
		return new JWinProject(
				...
				deserializeFileList(obj.getJSONArray(RESOLVED_JARS)), 
